...
import {
  ...
  MainText,
  BoxContent,
} from "./sign__up-style-components.js";
      ...
      <div className="wrapper2">
        <Container>
          ...
          <Box>
            <BoxContent>
              <Input
                ...
                className={
                  this.state.booleanForClassForName === true
                    ? "correct"
                    : this.state.booleanForClassForName === false
                    ? "incorrect"
                    : ""
                }
              ...
              <Input
                ...
                className={
                  this.state.booleanForClassForLastName === true
                    ? "correct"
                    : this.state.booleanForClassForLastName === false
                    ? "incorrect"
                    : ""
                }
            ...
            <Input
              ...
              className={
                this.state.booleanForClassForEmailAddress === true
                  ? "correct"
                  : this.state.booleanForClassForEmailAddress === false
                  ? "incorrect"
                  : ""
              }
            ...
            <Input
              ...
              className={
                this.state.booleanForClassForPassword === true
                  ? "correct"
                  : this.state.booleanForClassForPassword === false
                  ? "incorrect"
                  : ""
              }
              type="password"
          ...
          <Box>
            ...
            <Link to="/sign__in">Already have an account? Sign In</Link>
          </Box>
        </Container>
      </div>
    );
